...
export type ApiOrder = { id:string; reference:string; vendor:string; vendor_name:string; rider:string|null; rider_name:string|null; rider_phone:string|null; rider_status:ApiRiderStatus|null; pickup_address:string; delivery_address:string; recipient_name:string; recipient_phone:string; status:ApiOrderStatus; delivery_fee:string; created_at:string; updated_at:string }
