...
type Props = { vendorId:string|null; onClose:()=>void; onStatusChange:(vendor:Vendor,status:ApiStatus)=>void; statusLoading:boolean; statusError:string }

export function VendorDetails({vendorId,onClose,onStatusChange,statusLoading,statusError}:Props){
